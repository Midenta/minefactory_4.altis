...
if (_intersections isEqualTo []) exitWith {
  ...
  ["Es konnte leider keine Oberfläche gefunden werden",false,"fast"] call husky_fnc_notification_system;
    false
};
...
if ( !([ 0.5 * 0.6, 0.5 * 0.6] call _fnc_isOk) ||
    ...
    {!([-0.5 * 0.6,-0.5 * 0.6] call _fnc_isOk)}}}) exitWith {
      ...
      ["Die Oberfläche ist zu klein",false,"fast"] call husky_fnc_notification_system;
    false
};
