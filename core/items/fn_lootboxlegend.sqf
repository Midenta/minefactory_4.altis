...
private _items = [];
private _names = [];
private _itemarray = (getArray(missionConfigFile >> "husky_SETTINGS" >> "lootboxlegend_items"));
private _lootboxmoney = (getNumber(missionConfigFile >> "husky_SETTINGS" >> "lootboxlegend_money"));
...
c126 = c126 + _money;
hint parseText format ["<t font='PuristaBold' size='1.3' color='#d98921' align='center'>Loot Box Legendär</t>
