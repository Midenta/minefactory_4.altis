 ...
 *
 */
if ([220150,"dialog_gang_permission"] call husky_fnc_gang_activedialog) exitWith {hint localize "STR_aapps_gang_dialog_inuse"};
disableSerialization;
createDialog "husky_gang_grouppermission";
...
if (_type isEqualTo 0) then {
    ...
    _save ctrlSetEventHandler ["ButtonClick", '
        0 call husky_fnc_gang_saveeditgroups;
    '];
