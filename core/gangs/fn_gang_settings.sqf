 ...
 *
 */
if ([220250,"dialog_gang_settings"] call husky_fnc_gang_activedialog) exitWith {hint localize "STR_aapps_gang_dialog_inuse"};
closeDialog 0;
createDialog "husky_gang_groupsettings";
...
_ownrank = husky_GangData select 1;
