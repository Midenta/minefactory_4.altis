 ...
 *
 */
if ([220300,"dialog_gang_kickinvite"] call husky_fnc_gang_activedialog) exitWith {hint localize "STR_aapps_gang_dialog_inuse"};
disableSerialization;
createDialog "husky_gang_kickinvite";
_display = findDisplay 220300;
_listbox1 = _display displayCtrl 220302;
_listbox2 = _display displayCtrl 220303;
husky_gang_members =+ ((group player) getVariable ["gang_members",[]]);
['',''] spawn husky_fnc_gang_refreshinvite;
...
_listbox1 ctrlSetEventHandler ["LBDblClick",'
    ...
    _found = false;
    {
        ...
        _entry = _entry + 1;
    } forEach husky_gang_members;
    if (!_found) exitWith {};
    husky_gang_members deleteAt _entry;
    lbDelete [220302,_1];
...
_listbox1 ctrlSetEventHandler ["LBDrop",'
    ...
    lbSort 220302;
    husky_gang_members pushback [(_namearr select 0),1,_name,_plainobj];
...
_listbox2 ctrlSetEventHandler ["LbDblClick",'
    ...
    lbSort 220302;
    husky_gang_members pushBack [(_data select 0),1,_name,_plainobj];
