...
[[0,1],"STR_GNOTF_CaptureAreaProcess",true,[name player,_ownGroup getVariable "gang_name"]] remoteExecCall ["husky_fnc_broadcast",RCLIENT];
...
[[0,1],"STR_GNOTF_CaptureSuccess",true,[name player,_ownGroup getVariable "gang_name"]] remoteExecCall ["husky_fnc_broadcast",RCLIENT];
_hideout setVariable ["inCapture",false,true];


//c126 = c126 + 50000;
//hint parseText "<t underline='true' size='1.8' color='#7cff00'>Information</t><br /><t size='1.5' color='#ffffff'>Du hast 50.000 € durch das einnehmen des Gang Verstecks bekommen!</t>";
...
[getPlayerUID player, "captureHideout", format ["%1 - %2 hat dass Gang HQ %3 Gang %4 %5 eingenommen. Gangkonto %6 € Bargeld %7 € Bank %8 €",profileName,(getPlayerUID player),_number,_ownGroup,_name,[_gFund] call husky_fnc_numberText,[c126] call husky_fnc_numberText,[b126] call husky_fnc_numberText]] remoteExec ["HC_fnc_AdvancedLog",HC_Husky];
