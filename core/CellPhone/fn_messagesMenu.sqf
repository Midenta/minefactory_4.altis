...
createDialog "husky_cell_old_msgs";
...
{
	_playerList lbAdd format["Keine Nachrichten gefunden!"];
	_playerList lbSetdata [(lbSize _playerList)-1, "Du hast keine Nachrichten."];
}
else
{
	{
