...
_unit getVariable ["realname",name _unit],[(_ret select 0)] call husky_fnc_numberText,[(_ret select 1)] call husky_fnc_numberText, _uni,_vest,_bp,_prim,_sec,_attach,_steamName,(_ret select 5),(_ret select 6),_secondary];
