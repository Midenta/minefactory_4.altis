...
/*
	...
	this addAction[localize"STR_NOTF_captureGangHideout",husky_fnc_captureHideoutCop2,"",0,false,false,"",'playerSide isEqualTo west',4];
...
[2] remoteExecCall ["ton_fnc_gang_updateraid",RSERV];
