...
[getPlayerUID player, "Ticket Cop", format ["%1 - %2 hat %3 � durch das Ticket erhalten.",profileName,(getPlayerUID player),_value]] remoteExec ["HC_fnc_AdvancedLog",HC_Husky];
