...
private _val =parseNumber ctrlText 2652;
_val = floor(abs _val);
...
[0,"STR_Cop_TicketGive",true,[profileName,[_val2] call husky_fnc_numberText,husky_ticket_unit getVariable ["realname",name husky_ticket_unit]]] remoteExecCall ["husky_fnc_broadcast",RCLIENT];
[player,_val2,_bool] remoteExec ["husky_fnc_ticketPrompt",husky_ticket_unit];
closeDialog 0;

//[getPlayerUID player, "Ticket Give Cop", format ["%1 - %2 hat %3 � durch das Ticket erhalten.",profileName,(getPlayerUID player),_value]] remoteExec"HC_fnc_AdvancedLog",HC_Husky,2];