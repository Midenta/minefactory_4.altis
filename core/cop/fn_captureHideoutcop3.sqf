...
/*
	...
	this addAction[localize"STR_NOTF_captureGangHideout",husky_fnc_captureHideoutCop3,"",0,false,false,"",'playerSide isEqualTo west',4];
...
[3] remoteExecCall ["ton_fnc_gang_updateraid",RSERV];
