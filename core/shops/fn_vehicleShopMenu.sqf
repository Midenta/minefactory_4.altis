...
if (husky_SETTINGS(getNumber,"vehicleShop_3D") isEqualTo 1) then {
  createDialog "husky_Vehicle_Shop_v2_3D";
} else {
  createDialog "husky_Vehicle_Shop_v2";
};


husky_veh_shop = [_shop,_spawnpoints,_shopFlag,_disableBuy]; //Store it so so other parts of the system can access it.
