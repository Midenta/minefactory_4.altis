...
["Der Dietrich ist abgebrochen.",false,"fast"] call husky_fnc_notification_system;
waitUntil {ctrlCommitted _lpick};

if (([false,"lockpick",1] call husky_fnc_handleInv) == 0) exitwith {
	_display closeDisplay 0;
	["Du hast keine Dietriche mehr",true,"fast"] call husky_fnc_notification_system;
};
...
[format["Du hast noch %1 Dietrich(e)",[0,"lockpick"] call husky_fnc_handleVItem],false,"fast"] call husky_fnc_notification_system;
waitUntil {ctrlCommitted _lpick};
