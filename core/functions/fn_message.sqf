...
/*
* Author: Crunch
* Description: New Message System for Altis husky with Emojis --> Basiert natürlich null auf das von D100 #kappaKlaus
*/
params[
 "_text",
 ["_speed","",[""]],
...
husky_hints = ([[_Header,_TextField]] + husky_hints) select {!isNull (_x select 0) && !isNull (_x select 1)};