...
if (([0,"speedtrap"] call husky_fnc_handleVItem) <= 0) exitWith {};
...
private _onDone = {
	...
	if (!isNull _radar) then {
		detach _radar;
		if (([false,"speedtrap",1] call husky_fnc_handleInv) == 0) exitWith {
