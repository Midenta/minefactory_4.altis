...
class The_Programmer_DutyMenu {
   ...
   class controls
   {
       class Prendre : husky_RscButtonMenu
       {
           idc = 8002;
       ...
       class Arreter : husky_RscButtonMenu
       {
           idc = 8003;
       ...
       class Texte : husky_RscStructuredText
       {
           idc = 1000;
           x = 0.362083333333333 * safezoneW + safezoneX;
