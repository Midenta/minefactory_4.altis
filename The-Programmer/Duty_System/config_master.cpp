...
class The_programmer_Duty_Config {
    ...
    path_init = "core\Master_Directory\init.sqf"; // File destination to be executed : [] execVM "path_init";
    ...
    type_of_check = "level"; // type_of_check = "type";

    class Cop_Side_Configuration {
        coplevel_required = 1; // Minimum CopLevel level to take up duty
        required_license_cop[] = {"license_civ_driver"}; // All licenses that allows you to take up duty
    ...
    class Medic_Side_Configuration {
        ...
        required_license_medic[] = {"license_civ_boat"};
