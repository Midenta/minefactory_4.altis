...
if (_mode isEqualTo 0) then {
    ...
    if !(_type isEqualTo 0) then {
        ...
        (_display displayCtrl 5004) ctrlSetText format["%1 (%2/%3)",["PlayerInventory"] call cat_locker_fnc_getText,husky_carryWeight,husky_maxWeight];
    ...
    ctrlShow[5040,false];
    if (_mode isEqualTo 1) then {
        (_display displayCtrl 5004) ctrlSetText format["%1 (%2/%3)",["VehicleInventory"] call cat_locker_fnc_getText,(([cat_locker_vehicle] call husky_fnc_vehicleWeight) select 1),(([cat_locker_vehicle] call husky_fnc_vehicleWeight) select 0)];
