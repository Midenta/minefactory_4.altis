...
if (playerSide isEqualTo west) then {
    _playerLevel = call husky_coplevel;
...
if (playerSide isEqualTo independent) then {
    _playerLevel = call husky_mediclevel;
...
(_display displayCtrl 9507) ctrlSetStructuredText parseText format ["<img size='1.3' image='Scripts\cation\perm\ico_money.paa'/> <t font='PuristaMedium'>%1%2</t>",_cash,["currency"] call cat_perm_fnc_getText];
(_display displayCtrl 9508) ctrlSetStructuredText parseText format ["<img size='1.3' image='Scripts\cation\perm\ico_bank.paa'/> <t font='PuristaMedium'>%1%2</t>",_bank,["currency"] call cat_perm_fnc_getText];
