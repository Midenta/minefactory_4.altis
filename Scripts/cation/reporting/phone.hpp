class Cat_reporting_phone {
   ...
   class controlsBackground
   {
       class background : husky_RscPicture
       {
           ...
           text = "Scripts\cation\reporting\phone.paa";
           colorbackground[] = {};
           colortext[] = {};
   ...
   class controls
   {
       class delete : husky_RscButtonMenu
       {
           idc = 9713;
       ...
       class help : husky_RscButtonMenu
       {
           idc = 9721;
           x = 0.803792537001638 * safezoneW + safezoneX;
