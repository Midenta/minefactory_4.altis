...
private _attachPoint = getArray(missionConfigFile >> "emergLightVehicless" >> _vehType >> "pos"); //get coordinates of attachment point
private _class = "Jackeee_Blaulicht"; //classname of the object
