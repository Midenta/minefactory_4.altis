...
stig_sz_enable_WEST	= false;
stig_sz_enable_EAST	= false;
stig_sz_enable_GUER	= true;
...
//For example this is useful if you have a husky server and only want players with a minimum level to be able to use the system.
