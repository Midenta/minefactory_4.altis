...
with uiNamespace do {
	...
	_cur ctrlSetTooltip "Vorhandene Gefahrenzone grau markieren";
	...
	_cur ctrlSetTooltip "Gefahrenzone erstellen";
	_cur call _pushIntoArray;
	...
	_cur ctrlSetTooltip "Gefahrenzone entfernen";
	_cur call _pushIntoArray;
	...
	_cur ctrlSetText "Radius der Gefahrenzone:";
	...
	_cur = (call _display) ctrlCreate ["RscButton", -1];
	_cur ctrlSetText "Gefahrenzonensystem";
	_cur ctrlSetPosition [0.1625, 0.68, 0.4625, 0.08];
	_cur call _sideColor; //ctrlSetBackgroundColor [1,1,1,1];
	_cur ctrlCommit 0;
	_cur ctrlSetTooltip "";
	_cur buttonSetAction "hint 'Gefahrenzonenscript von Stig.\nZu finden auf Native-Network.net'";
	_cur call _pushIntoArray;
	...
	*/
	player createDiarySubject ["gefahrenzonensystem","Gefahrenzonensystem"];
	player createDiaryRecord ["gefahrensystem", ["UI ein-/ausblenden", "<br/><execute expression='call stig_sz_hideGUI'>Klicke hier, um das Overlay zur Gefahrenzonenverwaltung ein- oder auszublenden.</execute>" ]];
};
