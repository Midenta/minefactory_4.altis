...
_allInformations = [] call husky_fnc_getGambling2Info;

_chance = (_allInformations select 0);
_userInput = (_allInformations select 1);
_gamblingInput = (_allInformations select 2);

_winnerS = (missionNamespace getVariable ["Gambling2_AllWinners",[]]);
_betDatas = (missionNamespace getVariable ["Gambling2_AllDatas",[]]);

_betPlayerList = _display displayCtrl 21351;
_winnerSList = _display displayCtrl 21352;
_textBoxChance = _display displayCtrl 21357;
_textBoxMoneyToWin = _display displayCtrl 21358;
_textBoxYourInput = _display displayCtrl 21356;
_betButton = _display displayCtrl 21354;
