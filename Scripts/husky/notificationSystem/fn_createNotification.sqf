...
["This is a notification!", true, [0, 0, 0, 1], [1, 1, 0, 1], "New notification"] spawn husky_fnc_createNotification;
["<img size='1' color='#ffffff' image='\A3\Ui_f\data\GUI\Cfg\Ranks\private_gs.paa'/> New notification", "This is a notification!"] spawn husky_fnc_createNotification;
["<img size='1' align='right' color='#ffffff' image='\A3\Ui_f\data\GUI\Cfg\Ranks\private_gs.paa'/> New notification", "This is a notification!"] spawn husky_fnc_createNotification;
["<img size='1' align='right' color='#ffffff' image='\A3\Ui_f\data\GUI\Cfg\Ranks\private_gs.paa'/> Rank Promotion", "Good work!", [1, 1, 1, 1], [0.12, 0.63, 0.94, 1]] spawn husky_fnc_createNotification;

["Du kannst nicht mehr als 999.999 € abheben!", "Fehler"] spawn husky_fnc_createNotification;
[format["Du hast %1 € von deinem Bankkonto abgehoben.", [_value] call husky_fnc_numberText], "Information", [1, 1, 1, 1], [0,1,0,1]] spawn husky_fnc_createNotification;
*/
...
_numNotifications = 1 /*if (MAX_SHOWN_NOTIFICATIONS > 4) then {3} else {MAX_SHOWN_NOTIFICATIONS}*/;
