...
MRS_Init_GUI = {
	...
	MRS_GUI_Text0 ctrlSetText "Packbare Magazine";
	...
	MRS_GUI_Text1 ctrlSetText "Gepackte Magazine";
	...
	MRS_GUI_BtnRepack ctrlSetText "Magazine packen";
	MRS_GUI_BtnRepack ctrlEnable false;
	...
	MRS_GUI_BtnReset ctrlSetText "Reset";
