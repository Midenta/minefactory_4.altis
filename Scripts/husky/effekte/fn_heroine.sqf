...
_equilbre_max= 150/(1-damage player);
_equilibre_monte= 3/(1-damage player);
 
_flou_min= 0/(1-damage player);
_flou_max= 0.05/(1-damage player);
_flou_monte= 0.002/(1-damage player);
 
_couleurs_min= 0/(1-damage player);
_couleurs_max= 2/(1-damage player);
_couleurs_monte= 0.02/(1-damage player);
 
_frequence= 0.5;
_frequence_min= 0.1;
_frequence_max= 1;
_frequence_monte= 0.05;
...
[] spawn {
    ...
    sleep 30;		//time_when_player_cant_take_damages_with_heroin
