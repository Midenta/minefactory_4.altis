	...
	_vehicle addAction ["Pillar Vorne Bewegen",
		{
			if ((_this select 0) getVariable ["pillar1", true]) then
			{
				...
				[(_this select 0), true, true] remoteExec ["husky_fnc_MobileCopStationPillar", 0, true];
			} else {
				(_this select 0) setVariable ["pillar1", true, true];
				[(_this select 0), true, false] remoteExec ["husky_fnc_MobileCopStationPillar", 0, true];
			};
		}];
	_vehicle addAction ["Pillar Hinten Bewegen",
		{
			if ((_this select 0) getVariable ["pillar2", true]) then
			{
				...
				[(_this select 0), false, true] remoteExec ["husky_fnc_MobileCopStationPillar", -2, true];
			} else {
				(_this select 0) setVariable ["pillar2", true, true];
				[(_this select 0), false, false] remoteExec ["husky_fnc_MobileCopStationPillar", -2, true];
			};
		}];
