...
AuxSling_heavy_config = AuxSling_medium_config + AuxSling_heavy_config + ["Box_NATO_AmmoVeh_F", "Land_Cargo20_blue_F", "Land_Cargo20_brick_red_F", "Land_Cargo20_cyan_F", "Land_Cargo20_grey_F", "Land_Cargo20_light_blue_F", "Land_Cargo20_light_green_F", "Land_Cargo20_military_green_F", "Land_Cargo20_orange_F", "Land_Cargo20_red_F", "Land_Cargo20_sand_F", "Land_Cargo20_white_F", "Land_Cargo20_yellow_F", "Land_Cargo20_IDAP_F", "B_Slingload_01_Fuel_F","Land_Pod_Heli_Transport_04_fuel_F","Land_Device_slingloadable_F","Land_Device_assembled_F"]; //lift = 10000 e.g. Huron
...
AuxSling_fnc_DoAttaching = {
	...
	_nearUnits = nearestObjects [_veh, ["Car","Motorcycle","Tank","Ship","Autonomous","Air","ThingX"],11];
	...
	/*
	if (_list isEqualTo "AuxSling_heavy_config") then {
		[_unit,_obj,_ropecount,"Land_Cargo20_military_green_F"] spawn AuxSling_fnc_TheAttaching;
	};*/
		
	//in ["Box_NATO_AmmoVeh_F", "Land_Cargo20_blue_F", "Land_Cargo20_brick_red_F", "Land_Cargo20_cyan_F", "Land_Cargo20_grey_F", "Land_Cargo20_light_blue_F", "Land_Cargo20_light_green_F", "Land_Cargo20_military_green_F", "Land_Cargo20_orange_F", "Land_Cargo20_red_F", "Land_Cargo20_sand_F", "Land_Cargo20_white_F", "Land_Cargo20_yellow_F", "Land_Cargo20_IDAP_F", "B_Slingload_01_Fuel_F","Land_Pod_Heli_Transport_04_fuel_F","Land_Device_slingloadable_F","Land_Device_assembled_F"]
};
...
AuxSling_fnc_Conditions1 = {
	...
	if !(isNull _obj) then {
		_vehname = format ["<t color='#009900'> %1 anheben</t>",getText (configfile >> "CfgVehicles" >> typeOf _obj >> "displayName")];
		_unit setUserActionText [(_unit getVariable "AuxSling_Load_Action"),_vehname];
	} else {
		_unit setUserActionText [(_unit getVariable "AuxSling_Load_Action"),"<t color='#FF0000'>nicht möglich</t>"];
	};
...
AuxSling_fnc_Conditions2 = {
	...
	_vehname = format ["<t color='#FF0000'> %1 abtrennen</t>",getText (configfile >> "CfgVehicles" >> typeOf (_veh getVariable "AuxSling_AttachedObject") >> "displayName")];
...
AuxSling_fnc_AddAction = {
	...
	if (isNil {_unit getVariable "AuxSling_Added"}) then {
		AuxSling_Load_Action = _unit addAction ["<t color='#009900'>Last anheben</t>",{[(_this select 0)] spawn AuxSling_fnc_DoAttaching},"",-99,true,true,"",'[_this,_target] call AuxSling_fnc_Conditions1'];
		_unit setVariable ["AuxSling_Load_Action",AuxSling_Load_Action,true];
		AuxSling_unLoad_Action = _unit addAction ["<t color='#FF0000'>Last abtrennen</t>",{[(_this select 0)] spawn AuxSling_fnc_DoDetaching},"",-99,false,true,"",'[_this,_target] call AuxSling_fnc_Conditions2'];
