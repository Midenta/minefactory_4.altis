...
[] execVM "scripts\husky\GF_Explosive_Objects\GF_Distance_Check.sqf";
...
GF_EXO_Systemchat_info					= false;		
GF_EXO_Hintsilent_info					= false;
GF_EXO_diag_log_info					= false;
GF_EXO_Debug 							= false;

GF_EXO_Systemchat_info_count_items		= false;
GF_EXO_diag_log_info_count_items		= false;
