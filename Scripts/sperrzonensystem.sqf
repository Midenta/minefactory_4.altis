...
[[],
	...
	if (side player != west ) exitWith {};	//Einklammern wenn die neue Variante nicht geht
	//if ((call husky_coplevel) < 3 ) || playerSide != west) exitWith{};			//Ausklammern, wenn das nicht geht und das obere aktivieren
	...
	stig_sz_regler sliderSetRange [100,2000];
