...
if (IL_DevMod) then
{
	diag_log Format["IgiLoad ""%1"" IN.", IL_Script_Inst];
};
...
if (isnil "IL_Variables") then
{
	...
	// Supported vehicles
	IL_Supported_Vehicles_OFFROAD = ["C_Offroad_01_F", "B_G_Offroad_01_F", "B_mas_mar_Offroad_01_F", "I_E_Offroad_01_comms_F", "I_E_Offroad_01_covered_F", "B_GEN_Offroad_01_covered_F", "B_GEN_Offroad_01_comms_F", "C_Offroad_01_covered_F", "C_Offroad_01_comms_F"];
	IL_Supported_Vehicles_VAN = ["C_Van_01_transport_F"];	//"C_Van_01_box_F", "B_G_Van_01_transport_F", "C_Van_01_transport_F"
	IL_Supported_Vehicles_HEMTT = ["B_Truck_01_flatbed_F", "B_T_Truck_01_flatbed_F"];
	...
	IL_Supported_Vehicles_CHINOOK = [];	//"CH_147F", "CH_47F", "kyo_MH47E_HC", "kyo_MH47E_Ramp", "kyo_MH47E_base","B_Heli_Transport_03_unarmed_F","B_Heli_Transport_03_unarmed_green_F"
	IL_Supported_Vehicles_MH9 = [];	//"B_Heli_Light_01_F", "B_MBT_01_mlrs_F", "B_T_MBT_01_mlrs_F", "I_C_Heli_Light_01_civil_F", "B_mas_mar_Heli_Light_01_F"
	...
	//Supported cargo
	IL_Supported_HEMTT = ["B_Truck_01_covered_F", "B_T_Truck_01_covered_F", "B_Truck_01_transport_F", "B_T_Truck_01_transport_F", "B_Truck_01_box_F", "B_Truck_01_flatbed_F", "B_T_Truck_01_flatbed_F", "B_Truck_01_cargo_F", "B_T_Truck_01_cargo_F", "B_Truck_01_mover_F", "B_Truck_01_ammo_F", "B_Truck_01_fuel_F", "B_Truck_01_medical_F", "B_Truck_01_Repair_F"];
	...
	IL_Supported_Hunter = ["B_MRAP_01_F", "B_MRAP_01_gmg_F", "B_MRAP_01_hmg_F", "Marinir_B_MRAP_01_FG" , "Marinir_MRAP_01_gmg_FG", "Marinir_MRAP_01_hmg_FG", "B_mas_mar_MRAP_01_med_F", "B_mas_mar_MRAP_01_F", "B_mas_mar_MRAP_01_gmg_F", "B_mas_mar_MRAP_01_hmg_F","O_T_LSV_02_unarmed_F","B_T_LSV_01_unarmed_F","O_T_LSV_02_armed_F","C_Tractor_01_F"];
	...
	IL_Supported_VAN = ["C_Van_01_box_F", "B_G_Van_01_transport_F", "C_Van_01_transport_F","C_Van_02_vehicle_F","C_Van_02_transport_F","B_GEN_Van_02_vehicle_F","B_GEN_Van_02_transport_F"];
	IL_Supported_OFFROAD = ["C_Offroad_01_F", "B_G_Offroad_01_F", "B_G_Offroad_01_armed_F", "JTF2_Offroad_armed_01", "B_mas_mar_Offroad_01_F", "I_E_Offroad_01_comms_F", "I_E_Offroad_01_covered_F", "B_GEN_Offroad_01_covered_F","I_G_Offroad_01_armed_F", "B_GEN_Offroad_01_comms_F", "C_Offroad_01_covered_F", "C_Offroad_01_comms_F", "B_mas_mar_Offroad_01_armed_F", "Mrshounka_a3_smart_civ_noir" ,"Mrshounka_a3_smart_civ_bleu", "Mrshounka_a3_smart_civ", "Jonzie_Corolla", "ivory_supra", "DRPG_98Supra_Black", "DRPG_98Supra_white", "DRPG_98Supra_blue", "DRPG_98Supra_green", "DRPG_98Supra_yellow", "DRPG_98Supra_red", "DRPG_98Supra_orange", "DRPG_98Supra_pink", "DRPG_98Supra_purple", "jonzie_ceed", "apalon_lada_2108_sport_01", "apalon_lada_2108_sport_02", "jonzie_datsun_z432", "amg_caprice1993", "apalon_ladaniva2329", "ivory_wrx", "ivory_gt500", "jonzie_galant", "ivory_prius", "mrshounka_twingo_p", "zorak_renault_espace", "bv_the_crowner_aqua", "DRPG_11RS3_Black", "DRPG_11RS3_white", "DRPG_11RS3_blue", "DRPG_11RS3_green", "DRPG_11RS3_yellow", "DRPG_11RS3_red", "DRPG_11RS3_orange", "DRPG_11RS3_pink", "DRPG_11RS3_purple", "zorak_audi_rs3", "Mrshounka_rs4_civ_noir", "Mrshounka_rs4_civ_grise", "Mrshounka_rs4_civ_bleufonce", "Mrshounka_rs4_civ_orange", "Mrshounka_rs4_civ_jaune", "Mrshounka_rs4_civ_rose", "Mrshounka_rs4_civ_rouge", "Mrshounka_rs4_civ_violet", "shounka_a3_rs5_civ_noir", "shounka_a3_rs5_civ_grise", "shounka_a3_rs5_civ_bleufonce", "shounka_a3_rs5_civ_orange", "shounka_a3_rs5_civ", "shounka_a3_rs5_civ_jaune", "shounka_a3_rs5_civ_rose", "shounka_a3_rs5_civ_rouge", "shounka_a3_rs5_civ_violet", "shounka_rs6_noir", "shounka_rs6_grise", "shounka_rs6_bleufonce", "shounka_rs6_orange", "shounka_rs6", "shounka_rs6_jaune", "shounka_rs6_rose", "shounka_rs6_rouge", "shounka_rs6_violet", "shounka_a3_audiq7_bleu", "IVORY_R8", "IVORY_R8SPYDER", "VK_V_AUDI_A8_13_2013", "Quiet_v2_r8plus_blanche_f", "Quiet_v2_r8plus_bleu_f", "Quiet_v2_r8plus_chrome_f", "Quiet_v2_r8plus_noir_f", "Quiet_v2_r8plus_rouge_f", "shounka_limo_civ_noir", "shounka_limo_civ_grise", "X5_01", "X5_11", "X5_13", "X5_06", "X5_07", "X5_10", "X5_09", "zorak_bmw_x6m", "Mrshounka_bmwm1_civ_noir", "Mrshounka_bmwm1_civ_grise", "Mrshounka_bmwm1_civ_bleufonce", "Mrshounka_bmwm1_civ_orange", "Mrshounka_bmwm1_civ", "Mrshounka_bmwm1_civ_jaune", "Mrshounka_bmwm1_civ_rose", "Mrshounka_bmwm1_civ_rouge", "Mrshounka_bmwm1_civ_violet", "BMWM4_01", "BMWM4_11", "BMWM4_13", "BMWM4_06", "BMWM4_07", "BMWM4_10", "BMWM4_09", "M5_01", "M5_11", "M5_13", "M5_06", "M5_07", "M5_10", "M5_09","Mrshounka_bmwm6_civ_noir", "Mrshounka_bmwm6_civ_grise", "Mrshounka_bmwm6_civ_bleufonce", "Mrshounka_bmwm6_civ_orange", "Mrshounka_bmwm6_civ", "Mrshounka_bmwm6_civ_jaune", "Mrshounka_bmwm6_civ_rose", "Mrshounka_bmwm6_civ_rouge", "Mrshounka_bmwm6_civ_violet", "Fox_G37", "Fox_G37B", "Fox_G37G", "Fox_G37R", "Fox_G37Y", "Fox_G37Fox", "Fox_R34", "Fox_R34G", "Fox_R34R", "Fox_R34Y", "Fox_R34Fox", "Fox_SupraMk4", "Fox_SupraMk4G", "Fox_SupraMk4R", "Fox_SupraMk4Y", "Fox_SupraMk4Fox", "Fox_240SX", "Fox_240SXG", "Fox_240SXR", "Fox_240SXY", "Fox_240SXAPEX", "Fox_240SXAPEX2", "Fox_AE86", "Fox_AE86G", "Fox_AE86R", "Fox_AE86Y", "Fox_AE86Fox", "Fox_AE86Horbsner", "Fox_Impala16_NYPD", "fox_Tahoe_PoliceHWP", "Fox_Explorer16", "Fox_Charger16_HWP", "Fox_2015Tahoe_HWP", "Fox_Taurus16_HWP","Mustang_LVPD" ];
	...
	IL_Supported_Rubberboat = ["I_Boat_Transport_01_F", "O_Boat_Transport_01_F", "B_G_Boat_Transport_01_F", "B_Boat_Transport_01_F", "C_Rubberboat", "O_huskyboat", "B_huskyboat", "Marinir_duck_base_F", "B_mas_mar_Boat_Transport_01_F"];
	...
	IL_Supported_Container = ["Land_Cargo40_grey_F"];
	IL_Supported_CargoFuel = ["B_Slingload_01_Fuel_F","Land_Pod_Heli_Transport_04_fuel_F"];
	IL_Supported_CargoUran = ["Land_Device_slingloadable_F","Land_Cargo20_IDAP_F"];
	//TODO
	...
	IL_Supported_Cargo_NonVeh_Kamaz = IL_Supported_Supply_Crate + IL_Supported_Veh_Ammo + IL_Supported_Barrel + IL_Supported_Tank + IL_Supported_Box_H1 + IL_Supported_Box_H2 + IL_Supported_Cargo20 + IL_Supported_CargoFuel + IL_Supported_CargoUran + IL_Supported_Container;
...
// {
	// if (IL_DevMod) then
	// {
		// diag_log Format["IgiLoad. Object: ""%1"" is not supported.", _obj_main];
	// };
// };
...
if (isnil "IL_Procedures") then
{
	...
	IL_Init_Veh =
	{
		if (IL_DevMod) then
		{
			diag_log Format["IgiLoad ""%1"" IL_Init_Veh.", IL_Script_Inst];
		};
		...
		if (_obj_type in IL_Supported_Vehicles_MOHAWK) then
		{
			...
			if ((isNil {_obj getVariable "can_copilot"}) || (_force)) then {_obj setVariable["can_copilot", IL_Can_CoPilot, true];};
			if ((isNil {_obj getVariable "can_outside"}) || (_force)) then {_obj setVariable["can_outside", IL_Can_Outside, true];};
			if ((isNil {_obj getVariable "zload"}) || (_force)) then {_obj setVariable["zload", -2.25, true];};	//-2.25, true
		...
		if (_obj_type in IL_Supported_Vehicles_CHINOOK) then
		{
			...
			if (_obj_type in ["kyo_MH47E_HC", "kyo_MH47E_Ramp", "kyo_MH47E_base", "B_Heli_Transport_03_unarmed_F", "B_Heli_Transport_03_unarmed_green_F"]) then
			{
				if ((isNil {_obj getVariable "slots_num"}) || (_force)) then {_obj setVariable["slots_num", IL_Num_Slots_CHINOOK, true];};
		...
		if (_obj_type in IL_Supported_Vehicles_HEMTT) then
		{
			...
			{
				if ((isNil {_obj getVariable "zload"}) || (_force)) then {_obj setVariable["zload", -0.85, true];};	//-0.5, true
				if ((isNil {_obj getVariable "load_offset"}) || (_force)) then {_obj setVariable["load_offset", -0.10, true];};	//0, true
			};
		};
	};
//	END IL_Init_Veh
	...
	IL_Init_Box =
	{
		if (IL_DevMod) then
		{
			diag_log Format["IgiLoad ""%1"" IL_Init_Box.", IL_Script_Inst];
		};
		...
		if (_obj_type in IL_Supported_Cargo20) then
		{
			...
			_obj setVariable["cargo_offset", 2.1, true];//HEMETT Box ~2.09281			//2.6, true
			//LOCAL
			//_obj setMass 2400;
			[_obj, 3750] call IL_SetNewMass;		//3400
			//_turn = true;		//force rotation? true
		};

		 if (_obj_type in IL_Supported_Container) then
        {
            _obj setVariable["slots", 6, true];
            _obj setVariable["cargo_offset", 2.1, true];//HEMETT Box ~2.09281
            //LOCAL
            //_obj setMass 5000;
            [_obj, 5000] call IL_SetNewMass;
        };
		
		if (_obj_type in IL_Supported_CargoFuel) then
		{
			_obj setVariable["slots", 6, true];
			_obj setVariable["cargo_offset", 2.1, true];//HEMETT Box ~2.09281			//2.6, true
			//LOCAL
			//_obj setMass 2400;
			[_obj, 3400] call IL_SetNewMass;		//3400
			_obj setFuelCargo 0;	//Fuel 0/Kein Tanken an dem Ding
		};
		
		if (_obj_type in IL_Supported_CargoUran) then
		{
			_obj setVariable["slots", 6, true];
			_obj setVariable["cargo_offset", 2.1, true];//HEMETT Box ~2.09281			//2.6, true
			//LOCAL
			//_obj setMass 2400;
			[_obj, 3400] call IL_SetNewMass;		//3400
			_obj enableSimulation true;			//Simulation, schwebt ne in der luft
		};

		if (_obj_type in IL_Supported_HEMTT) then
		{
			_obj setVariable["slots", 10, true];
			_obj setVariable["cargo_offset", 4.2, true];		// 4.2, true
		};
...
//	END IL_Init_Box
	...
	IL_Server_AddScore =
	{
		if (IL_DevMod) then
		{
			diag_log Format["IgiLoad ""%1"" IL_Server_AddScore.", IL_Script_Inst];
		};
		if (isServer) then
		{
...
//	END IL_Score
	...
	IL_Server_SetDir =
	{
		if (IL_DevMod) then
		{
			diag_log Format["IgiLoad ""%1"" IL_Server_SetDir.", IL_Script_Inst];
		};
		private ["_obj", "_dir"];
		...
		*/
		...
		_obj setDir _dir;
		//diag_log format ["%1 KACCKE DREH DICH",_dir];
...
//	END publicVariable "IL_SetDir";
	...
	IL_Rotate =
	{
		...
		//diag_log format ["%1 %2 %3 ROTATION111",_change,_obj,_to];
		...
		else
		{
			...
			/*else
			{
				(owner _obj) publicVariableServer "IL_SetDir";		//publicVariableServer "IL_SetDir"; //  ohne (owner _obj)
			};*/
			//["Cos", IL_SetDir] spawn IL_Server_SetDir;
			/*["Cos", IL_SetDir] spawn IL_Server_SetDir2;
			diag_log "rotate 3";
		};*/
	};
//	END IL_Rotate
	...
	IL_Server_SetMass =
	{
		if (IL_DevMod) then
		{
			diag_log Format["IgiLoad ""%1"" IL_Server_SetMass.", IL_Script_Inst];
		};
		private ["_obj", "_mass"];
		_obj = _this select 1 select 0;
...
//	END IL_GetDefaultMass
	...
	IL_SetNewMass =
	{
		if (IL_DevMod) then
		{
			diag_log Format ["IgiLoad ""%1"" in IL_SetMass", IL_Script_Inst];
		};
...
//	END IL_SetNewMass
	...
	IL_Vehicle_Chat =
	{
		...
		if (_mass_info && IL_Mass) then
		{
			...
			_text = _text + "<t color='#00aafd' size='1.2' shadow='1' shadowColor='#000000' align='left'>Standardgewicht: </t>";
			_text = _text + Format ["<t color='#ffff00' size='1.2' shadow='1' shadowColor='#000000' align='left'>%1</t><br/>", _v_def_mass];

			_text = _text + "<t color='#00aafd' size='1.2' shadow='1' shadowColor='#000000' align='left'>Ladungsgewicht: </t>";
			_text = _text + Format ["<t color='#ffff00' size='1.2' shadow='1' shadowColor='#000000' align='left'>%1</t><br/>", _cargo_mass];

			_text = _text + "<t color='#00aafd' size='1.2' shadow='1' shadowColor='#000000' align='left'>Aktuellesgewicht: </t>";
...
//	END IL_Vehicle_Chat
	...
	IL_Move_Attach=
	{
		...
		if (IL_DevMod) then
		{
			diag_log Format ["IgiLoad ""%1"". IL_Move_Attach _from_x =""%2"", _from_y =""%3"", _from_z =""%4""", IL_Script_Inst, _from_x, _from_y, _from_z];
		};
		...
		if (IL_DevMod) then
		{
			diag_log Format ["IgiLoad ""%1"". IL_Move_Attach _to_x =""%2"", _to_y =""%3"", _to_z =""%4""", IL_Script_Inst, _to_x, _to_y, _to_z];
		};

		_x = _to_x - _from_x;
		//_x = -90;				//position rechts links
		_y = _to_y - _from_y;	//position vor hinter
		_z = _to_z - _from_z;
		//_z = -90;				//Höhe
		if (IL_DevMod) then
		{
			diag_log Format ["IgiLoad ""%1"". IL_Move_Attach _x =""%2"", _y =""%3"", _z =""%4""", IL_Script_Inst, _x, _y, _z];
		};
		...
		if (((abs _x) > (abs _y)) && ((abs _x) > (abs _z))) then
		{
			...
			if (IL_DevMod) then
			{
				diag_log Format ["IgiLoad ""%1"". IL_Move_Attach _x > _y and _z, _steps =""%2""", IL_Script_Inst, _steps];
			};
		}
		else
		{
			if ((abs _y) > (abs _z)) then
			{
				...
				if (IL_DevMod) then
				{
					diag_log Format ["IgiLoad ""%1"". IL_Move_Attach _y > _z, _steps =""%2""", IL_Script_Inst, _steps];
				};
			}
			else
			{
				...
				if (IL_DevMod) then
				{
					diag_log Format ["IgiLoad ""%1"". IL_Move_Attach _z > _y, _steps =""%2""", IL_Script_Inst, _steps];
				};
			};
		};
		...
		while {_i < _steps} do
		{
			...
			if (IL_DevMod) then
			{
				diag_log Format ["IgiLoad ""%1"". IL_Move_Attach _pos =""%2""", IL_Script_Inst, _pos];
			};

			sleep 0.25;
			//_turn = true;	//dreht sich beim beladen//ist doof wenns sich da dreht :P
			//diag_log format ["%1 turn1",_turn];
		};
...
//	END IL_Move_Attach
	...
	IL_Create_And_Attach =
	{
		if (IL_DevMod) then
		{
			diag_log Format ["IgiLoad ""%1"" in IL_Create_And_Attach", IL_Script_Inst];
		};
...
//	END IL_Create_And_Attach
	...
	IL_Cargo_Para =
	{
		if (IL_DevMod) then
		{
			diag_log Format ["IgiLoad ""%1"" in IL_Cargo_Para", IL_Script_Inst];
		};
...
//	END IL_Cargo_Para
	...
	IL_Do_Load =
	{
		if (IL_DevMod) then
		{
			diag_log Format ["IgiLoad ""%1"" in IL_Do_Load", IL_Script_Inst];
		};
		...
		_NoBoxHint = "Die Box ist in der Nähe. Vielleicht liegt es außerhalb der Ladefläche.";
		_v = _this select 0;
		...
		_counter = 0;
		_done = false;
		_turn = false;		//Force rotation????	//rotation beim entladen ist uninteressant

		if ((_obj_type in IL_Supported_Vehicles_VAN) && (_doors == "B")) then
		{
			if (IL_DevMod) then
			{
				diag_log Format ["IgiLoad ""%1"". Do_load vehicle type: ""%2"" and doors: ""%3""", IL_Script_Inst, _obj_type, _doors];
			};
			_sdist = IL_SDistL;
		...
		if ((_obj_type in IL_Supported_Vehicles_HEMTT) && (_doors == "B")) then
		{
			...
			_sdist = IL_SDistL;
			_spoint = _v modelToWorld [0,-6.5 - (_v getVariable "load_offset"),0];		//0,-7 -
			_box_num = _v getVariable "box_num";
			_slot_num = _v getVariable "slots_num";
		};
		...
		{
			{
				if (IL_DevMod) then
				{
					diag_log Format ["IgiLoad ""%1"". Cargo: ""%2"" found.", IL_Script_Inst, _x];
				};
				if (isNil {_x getVariable "attachedPos"}) then
				{
					if (IL_DevMod) then
					{
						diag_log Format ["IgiLoad ""%1"". Init box: ""%2"".", IL_Script_Inst, _x];
					};
					[_x] call IL_Init_Box;
				};
				...
				if ((typeOf _x) in (IL_Supported_CargoFuel)) then
				{
					_turn = false;
				};
				if ((typeOf _x) in (IL_Supported_CargoUran)) then
				{
					_turn = false;
				};
				...
				else
				{
					if (IL_DevMod) then
					{
						diag_log Format ["IgiLoad ""%1"". _box_num: ""%2"" _slot_num: ""%3""", IL_Script_Inst,  _box_num, _slot_num];
					};
					if (_obj_type in IL_Supported_Vehicles_MH9) then
					{
						_turn = !_turn;
					...
					if ((_box_num > _slot_num) && !_done) then
					{
						...
						if ((_obj_type in IL_Supported_Vehicles_HEMTT) && (_doors == "B")) then		//TURN MAL ÄNDERN AUF 90 oder so //Geht nd
						{
							//_turn = -90;
							[_v, _x, [_x_cargo_offset,-6.5 - _cargo_offset,_zload], [_x_cargo_offset,_counter + 0 - _cargo_offset,_zload], 1, _turn] call IL_Move_Attach;	//[_x_cargo_offset,-7
							//diag_log format ["%1 turn3",_turn];
							//diag_log format ["%1 %2 %3 %4 turn9",_v,_x,_zload,_turn];
						};
						if ((_obj_type in IL_Supported_Vehicles_TEMPEST) && (_doors == "B")) then
						{
						...
						{
							[_v, Format ["""%1"" wird geladen auf ""%2"". Freie Plätze: ""%3"".", getText(configFile >> "cfgVehicles" >> typeOf _x >> "displayName"), getText(configFile >> "cfgVehicles" >> typeOf _v >> "displayName"), abs(_slot_num - _counter)], true] call IL_Vehicle_Chat;
						}
						else
						{
							//_turn = 90;
							[_v, Format ["""%1"" wird geladen auf ""%2"" Es ist kein Platz mehr.", getText(configFile >> "cfgVehicles" >> typeOf _x >> "displayName"), getText(configFile >> "cfgVehicles" >> typeOf _v >> "displayName")], true] call IL_Vehicle_Chat;
							
							//diag_log format ["%1 turn2",_turn];
						};
...
//	END IL_Do_Load
	...
	IL_Do_Unload =
	{
		if (IL_DevMod) then
		{
			diag_log Format["IgiLoad ""%1"" IL_Do_Unload.", IL_Script_Inst];
		};
		...
		{
			{
				...
				if (_x getVariable "doors" == _doors) then
				{
					...
					{
						[_v, Format ["Entladung ""%1"" von ""%2"" gestartet", getText(configFile >> "cfgVehicles" >> typeOf _x >> "displayName"), getText(configFile >> "cfgVehicles" >> typeOf _v >> "displayName")]] call IL_Vehicle_Chat;
						_done = true;
						_skip = false;
						_zload = (_v getVariable "zload") + (_x getVariable "zload_cargo");
						_cargo_offset = (_v getVariable "load_offset") + (_x getVariable "cargo_offset");
						...
						{
							//_turn = false;
							[_v, _x, [_x_cargo_offset,_counter + 0 - _cargo_offset,_zload], [_x_cargo_offset,-6.5 - _cargo_offset,_zload], 1, _turn] call IL_Move_Attach;	//[_x_cargo_offset,-7
							//diag_log format ["%1 turn4",_turn];		//Entlade rotation
						};
						if ((_obj_type in IL_Supported_Vehicles_TEMPEST) && (_doors == "B")) then
						{
						...
						[_v, Format ["""%1"" wurde aus dem ""%2"" entladen. Freie Plätze: ""%3"".", getText(configFile >> "cfgVehicles" >> typeOf _x >> "displayName"), getText(configFile >> "cfgVehicles" >> typeOf _v >> "displayName"), _free_slots], true] call IL_Vehicle_Chat;
						//player addScore IL_Unload_Score;
						[Player, IL_Unload_Score] call IL_Score;
						sleep 1;
					};
			...
			if (_skip) then
			{
				[_v, "Kann keine Ladung finden. Versuche es nochmal."] call IL_Vehicle_Chat;
...
//	END IL_Do_Unload
	...
	IL_GetOut =
	{
		if (IL_DevMod) then
		{
			diag_log Format["IgiLoad ""%1"" IL_GetOut.", IL_Script_Inst];
		};
...
//				_chute setPos getPos _player;
		...
		if (IL_DevMod) then
		{
			diag_log Format["IgiLoad ""%1"" IL_GetOut. Player ATL: ""%2""", IL_Script_Inst, _pos];
		};
	};
//	END IL_GetOut
};
...
if (_obj_main_type in IL_Supported_Vehicles_MOHAWK) then
{
	if (IL_DevMod) then
	{
		diag_log Format["IgiLoad ""%1"" Vehicle is in IL_Supported_Vehicles_MOHAWK.", IL_Script_Inst];
	};
	_vsupported = true;
	[_obj_main] call IL_Init_Veh;

	_obj_main addAction [
	"<img image='Scripts\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Lade Box in CH-49</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#007f0e"">Steige in CH-49</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#ff0000"">Steige aus CH-49</t>",
	{
	...
	_obj_main addAction [
	"<img image='Scripts\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Lade Box aus CH-49</t>",
	{
	...
	_obj_main addAction [
	"<img image='Scripts\IgiLoad\images\unload_para.paa' /><t color=""#b200ff"">  Box mit Fallschrim abwerfen</t>",
	{
	...
	_obj_main addAction [
	"<img image='Scripts\IgiLoad\images\unload_all_para.paa' /><t color=""#a50b00"">  Alle Boxen mit Fallschirm abwerfen</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Öffne Laderampe von CH-49</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Schließe Laderampe von CH-49</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Aktiviere das laden vom Co-Pilot</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Deaktiviere das laden vom Co-Pilot</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Aktiviere das beladen von außen</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Deaktiviere das beladen von außen</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Aktiviere Rampe</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Deaktiviere Rampe</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_CHINOOK) then
{
	if (IL_DevMod) then
	{
		diag_log Format["IgiLoad ""%1"" Vehicle is in IL_Supported_Vehicles_CHINOOK.", IL_Script_Inst];
	};
	_vsupported = true;
	[_obj_main] call IL_Init_Veh;
	...
	if (typeOf _obj_main in ["kyo_MH47E_HC", "kyo_MH47E_Ramp", "kyo_MH47E_base", "B_Heli_Transport_03_unarmed_F", "B_Heli_Transport_03_unarmed_green_F"]) then
	{
		_obj_main addAction [
		"<img image='Scripts\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on Chinook</t>",
		{
...
if (_obj_main_type in IL_Supported_Vehicles_C130J) then
{
	if (IL_DevMod) then
	{
		diag_log Format["IgiLoad ""%1"" Vehicle is in IL_Supported_Vehicles_C130J.", IL_Script_Inst];
	};
	_vsupported = true;
	[_obj_main] call IL_Init_Veh;
...
if (_obj_main_type in IL_Supported_Vehicles_C17) then
{
	if (IL_DevMod) then
	{
		diag_log Format["IgiLoad ""%1"" Vehicle is in IL_Supported_Vehicles_C17.", IL_Script_Inst];
	};
	_vsupported = true;
	[_obj_main] call IL_Init_Veh;
...
if (_obj_main_type in IL_Supported_Vehicles_MH9) then
{
	if (IL_DevMod) then
	{
		diag_log Format["IgiLoad ""%1"" Vehicle is in IL_Supported_Vehicles_MH9.", IL_Script_Inst];
	};
	_vsupported = true;
	[_obj_main] call IL_Init_Veh;
...
//////////////////////////////////////////////////
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Beladen aktivieren</t>",
	{
		(_this select 0) setVariable["can_outside", true, true];;
	},[],IL_Action_S_Priority,false,true,"",
	"(((driver _target == _this) || (('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot'))) && !(_target getVariable 'can_outside') && IL_Can_Outside)"
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Beladen deaktivieren</t>",
	{
		(_this select 0) setVariable["can_outside", false, true];;
	},[],IL_Action_S_Priority,false,true,"",
	"(((driver _target == _this) || (('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot'))) && (_target getVariable 'can_outside') && IL_Can_Outside)"
...
if (_obj_main_type in IL_Supported_Vehicles_OFFROAD) then
{
	if (IL_DevMod) then
	{
		diag_log Format["IgiLoad ""%1"" Vehicle is in IL_Supported_Vehicles_OFFROAD.", IL_Script_Inst];
	};
	_vsupported = true;
	[_obj_main] call IL_Init_Veh;

	_obj_main addAction [
	"<img image='Scripts\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Belade Offroad</t>",
	{
	...
	_obj_main addAction [
	"<img image='Scripts\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Entlade Offroad</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
...
if (_obj_main_type in IL_Supported_Vehicles_VAN) then
{
	if (IL_DevMod) then
	{
		diag_log Format["IgiLoad ""%1"" Vehicle is in IL_Supported_Vehicles_VAN.", IL_Script_Inst];
	};
	_vsupported = true;
	[_obj_main] call IL_Init_Veh;

	_obj_main addAction [
	"<img image='Scripts\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Belade VAN</t>",
	{
	...
	_obj_main addAction [
	"<img image='Scripts\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Entlade VAN</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
...
if (_obj_main_type in IL_Supported_Vehicles_KAMAZ) then
{
	if (IL_DevMod) then
	{
		diag_log Format["IgiLoad ""%1"" Vehicle is in IL_Supported_Vehicles_KAMAZ.", IL_Script_Inst];
	};
	_vsupported = true;
	[_obj_main] call IL_Init_Veh;

	_obj_main addAction [
	"<img image='Scripts\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Belade ZAMAK</t>",
	{
	...
	_obj_main addAction [
	"<img image='Scripts\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Entlade ZAMAK</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
...
if (_obj_main_type in IL_Supported_Vehicles_TEMPEST) then
{
	if (IL_DevMod) then
	{
		diag_log Format["IgiLoad ""%1"" Vehicle is in IL_Supported_Vehicles_TEMPEST.", IL_Script_Inst];
	};
	_vsupported = true;
	[_obj_main] call IL_Init_Veh;

	_obj_main addAction [
	"<img image='Scripts\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Belade TEMPEST</t>",
	{
	...
	_obj_main addAction [
	"<img image='Scripts\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Entlade TEMPEST</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
...
if (_obj_main_type in IL_Supported_Vehicles_HEMTT) then
{
	if (IL_DevMod) then
	{
		diag_log Format["IgiLoad ""%1"" Vehicle is in IL_Supported_Vehicles_HEMTT.", IL_Script_Inst];
	};
	_vsupported = true;
	[_obj_main] call IL_Init_Veh;

	_obj_main addAction [
	"<img image='Scripts\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Lade auf HEMTT</t>",
	{
		//_turn = false;	//Testen 2
		[_this select 0, IL_Supported_Cargo_NonVeh_HEMTT] call IL_Do_Load;
		//diag_log "TEsten 2";
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-6.5 - (_target getVariable 'load_offset'),0], IL_Supported_Cargo_NonVeh_HEMTT, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-7 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];

	_obj_main addAction [
	"<img image='Scripts\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Belade HEMTT</t>",
	{
		[_this select 0, IL_Supported_Cargo_Veh_HEMTT] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-6.5 - (_target getVariable 'load_offset'),0], IL_Supported_Cargo_Veh_HEMTT, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-7 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];

	_obj_main addAction [
	"<img image='Scripts\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Entlade HEMTT</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
...
{
	diag_log Format["Object type: ""%1"" wird nicht unterstüzt.", _obj_main_type];
};

if (IL_DevMod) then
{
	diag_log Format["IgiLoad ""%1"" END.", IL_Script_Inst];
};
//	EOF
