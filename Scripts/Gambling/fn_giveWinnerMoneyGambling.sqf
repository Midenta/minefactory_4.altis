...
hint parseText format["<t size='1.5' color='#AEB404'>Gambling</t><br/><br/><t size='1.2' color='#CECEF6'>Herzlichen Glückwunsch !</t><br/>%1, du hast diese Runde das Gambling gewonnen !<br/>Gewinn Brutto : <t color='#00FF00'>+%2</t><br/>Gewinn Netto : <t color='#00FF00'>+%6</t><br/>Chance : %3%4<br/>Input : %5",_myName,[_wonMoney] call husky_fnc_numberText,[_chance] call husky_fnc_numberText,"%",[_myInput] call husky_fnc_numberText,[_wonMoneySx] call husky_fnc_numberText];

[getPlayerUID player, "Gambling Winner", format ["%1, du hast diese Runde das Gambling gewonnen !Gewinn Brutto : +%2 Gewinn Netto : +%6 Chance : %3%4 Input : %5  Bankkonto: %6 �  Bargeld: %7",_myName,[_wonMoney] call husky_fnc_numberText,[_chance] call husky_fnc_numberText,"%",[_myInput] call husky_fnc_numberText,[_wonMoneySx] call husky_fnc_numberText,[b126] call husky_fnc_numberText,[c126] call husky_fnc_numberText]] remoteExec ["HC_fnc_AdvancedLog",HC_Husky];
