class TTM_GUI_RscDisplayTalentOverview {
    ...
    class controls {
		...
		class textCurrentRank: husky_RscStructuredText
		{
			idc = 3;
			text = ""; //--- ToDo: Localize;
			x = 0.298906 * safezoneW + safezoneX;
		...
		class textRankName: husky_RscText
		{
			idc = 4;
			text = ""; //--- ToDo: Localize;
		...
		class textStatusInfo: husky_RscText
		{
			idc = 5;
			text = ""; //--- ToDo: Localize;
			x = 0.343156 * safezoneW + safezoneX;
		...
		class RscText_1700: husky_RscText
		{
			idc = -1;
			x = 0.340156 * safezoneW + safezoneX;
			y = 0.291 * safezoneH + safezoneY;
		...
		class progressRankProgress: husky_RscProgress
		{
			idc = 6;
			x = 0.340156 * safezoneW + safezoneX;
			y = 0.291 * safezoneH + safezoneY;
		...
		class textPerkName: husky_RscText
		{
			idc = 8;
		...
		class textPerkSubtitle: husky_RscText
		{
			idc = 9;
		...
		class textPerkDescription: husky_RscStructuredText
		{
			idc = 11;
			x = 0.494844 * safezoneW + safezoneX;
