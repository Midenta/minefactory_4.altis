...
[] spawn {
	...
	husky_perksInitialized = false;
	husky_currentExpPerks = (0 call mav_ttm_fnc_generateBasePerks);
	husky_currentExpLevel = 0;
	husky_currentExp = 0;
	husky_currentPerkPoints = 0;
	...
	[] spawn {
		while {!husky_perksInitialized} do
		{
			sleep 5;
