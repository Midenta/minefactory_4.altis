...
if (_index == -1) exitWith {
	["<t size='1' align='center' shadow='2' font='PuristaMedium' color='#ff0000'>Bitte wählen Sie zuerst eine Modifikation</t>"] spawn mav_tuning_fnc_displayText;
};
...
if (husky_cash < _price) exitWith {
	["<t size='1' align='center' shadow='2' font='PuristaMedium' color='#ff0000'>Sie haben nicht genug Geld, um diese Modifikation zu kaufen</t>"] spawn mav_tuning_fnc_displayText;
};
...
if (_subConfig == "RGB" AND _class == "Colors") exitWith {
	...
	[format["<t size='1' align='center' shadow='2' font='PuristaMedium'>Sie haben eine Modifikation für gekauft <t color='#12FE00'>%1 €</t><br/>Du hast <t color='#12FE00'>%2 €</t> left</t>",[mav_tuning_rgbprice] call BIS_fnc_numberText,[husky_cash] call BIS_fnc_numberText]] spawn mav_tuning_fnc_displayText;
...
if (true) then {
	...
	if ((str _originalData) == (str mav_tuning_previewData)) exitWith {
		["<t size='1' align='center' shadow='2' font='PuristaMedium' color='#ff0000'>Sie besitzen diese Modifikation bereits</t>"] spawn mav_tuning_fnc_displayText;
	};
	...
	[_newArray,vehicle player] spawn mav_tuning_fnc_loadVehicleModification;
 	...
 	// Money duh
 	husky_cash = husky_cash - _price;
	[format["<t size='1' align='center' shadow='2' font='PuristaMedium'>Sie haben eine Modifikation für gekauft <t color='#12FE00'>%1 €</t><br/>Du hast <t color='#12FE00'>%2 €</t> left</t>",[_price] call BIS_fnc_numberText,[husky_cash] call BIS_fnc_numberText]] spawn mav_tuning_fnc_displayText;
