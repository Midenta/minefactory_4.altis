...
((findDisplay 5200) displayCtrl 3) ctrlAddEventHandler ["ButtonClick",{
	...
	closeDialog 0;
	[format["<t size='1' align='center' shadow='2' font='PuristaMedium'>Unterleuchtung erfolgreich hinzugefügt, drücken Sie SHIFT-L, um zu aktivieren<br/><t color='#12FE00'>%1 €</t> left</t>",[husky_cash] call BIS_fnc_numberText]] spawn mav_tuning_fnc_displayText;
}];
...
((findDisplay 5200) displayCtrl 4) ctrlAddEventHandler ["ButtonClick",{
	...
	// Refund money
	husky_cash = husky_cash + mav_tuning_rgbprice;
	[format["<t size='1' align='center' shadow='2' font='PuristaMedium'><t color='#12FE00'>%1 €</t> wurden Ihrem Konto gutgeschrieben<br/><t color='#12FE00'>%2 €</t> left</t>",[mav_tuning_rgbprice] call BIS_fnc_numberText,[husky_cash] call BIS_fnc_numberText]] spawn mav_tuning_fnc_displayText;
}];
