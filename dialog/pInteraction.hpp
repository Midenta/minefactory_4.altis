...
class pInteraction_Menu {
   ...
   class controls
   {
       class ButtonClose : husky_RscButtonMenu
       {
           ...
           x = 0.636823166666667 * safezoneW + safezoneX;
           y = 0.685138126773889 * safezoneH + safezoneY;
           w = 0.113437 * safezoneW;
           h = 0.022 * safezoneH;
           colorbackground[] = {0,0,0,0.4};
           idc = 1000;
       ...
       class Buttonelefen : husky_RscButtonMenu
       {
           idc = 37460;
           colorbackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
           text = "";
           x = 0.641979166666667 * safezoneW + safezoneX;
           y = 0.647467360454116 * safezoneH + safezoneY;
           w = 0.103125 * safezoneW;
           h = 0.022 * safezoneH;
       };
   };
