...
class husky_RscControlsGroup {
    ...
    class VScrollBar : husky_RscScrollBar
    {
        width = 0.021;
        autoScrollEnabled = 1;
    };

    class HScrollBar : husky_RscScrollBar
    {
        height = 0.028;
    };
...
class husky_RscControlsGroupNoScrollbars : husky_RscControlsGroup {
...
class husky_RscListNBox
{
	...
	autoScrollDelay = 5;
	autoScrollRewind = 0;
	class ListScrollBar: husky_RscScrollBar{};
	class ScrollBar: husky_RscScrollBar{};
	idcLeft = -1;
	idcRight = -1;
};
...
class husky_RscLine: husky_RscText {
    idc = -1;
    style = 176;
    x = 0.17;
    y = 0.48;
...
class husky_RscTitle: husky_RscText {
    style = 0;
    sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
    colorText[] = {0.95, 0.95, 0.95, 1};
};

class husky_RscPicture {
    shadow = 0;
    type = 0;
    style = 48;
    sizeEx = 0.023;
...
class husky_RscTextMulti: husky_RscText
{
    linespacing = 1;
    style = 0 + 16 + 0x200;
};

class husky_RscPictureKeepAspect : husky_RscPicture
{
    style = 0x30 + 0x800;
};

class husky_RscStructuredText {
    type = 13;
    style = 0;
    x = 0;
    y = 0;
...
class husky_RscButtonTextOnly : husky_RscButton {
...
class husky_RscButtonMenu : husky_RscShortcutButton {
    idc = -1;
    type = 16;
    style = "0x02 + 0xC0";
    default = 0;
...
class husky_RscShortcutButtonMain : husky_RscShortcutButton {
    idc = -1;
    style = 0;
    default = 0;
    w = 0.313726;
...
class husky_RscEditMulti: husky_RscEdit {
	style = ST_MULTI;
};

class husky_RscSlider {
    h = 0.025;
    color[] = {1, 1, 1, 0.8};
    colorActive[] = {1, 1, 1, 1};
};

class husky_RscXSliderH
{
    style = 1024;
    type = 43;
    shadow = 2;
...
class husky_RscBackground: husky_RscText {
    type = 0;
    IDC = -1;
    style = 512;
    shadow = 0;
...
class husky_RscCombo {
    ...
    class ComboScrollBar : husky_RscScrollBar {};
};

class husky_RscToolbox {
    colorText[] = {0.95, 0.95, 0.95, 1};
    color[] = {0.95, 0.95, 0.95, 1};
