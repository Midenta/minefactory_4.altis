class husky_Admin_Compensate {
    idd = 9920;
    name= "husky_admin_compensate_give";
    movingEnable = 0;
    enableSimulation = 1;
    ...
    class controls {
        ...
        class AdminCloseComp: husky_RscButtonMenu {
            idc = -1;
        ...
        class AdminCompensVer: husky_RscButtonMenu {
            idc = -1;
            text = "$STR_Admin_Compensate";
            colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
            onButtonClick = "[] spawn husky_fnc_adminCompensate;";
            x = 0.27;
            y = 0.40;
            w = (6.25 / 40);
            h = (1 / 25);
        ...
        class AdminCompensTex: husky_RscEdit {
            idc = 9922;
            text = "";
