...
class aapps_admintool
{
	...
	{
		class spielerlistebackground: husky_RscText
		{
			idc = -1;
		...
		class beschreibungbackground: husky_RscText
		{
			idc = -1;
		...
		class functionbackground: husky_RscText
		{
			idc = -1;
		...
		class spielerlisteheader: husky_RscText
		{
			idc = -1;
		...
		class functionheader: husky_RscText
		{
			idc = -1;
		...
		class beschreibungheader: husky_RscText
		{
			idc = -1;
	...
	class controls
	{
		class spielerlistelist: husky_RscListBox
		{
			idc = 9999991;
		...
		class functionlist: husky_RscListBox
		{
			idc = 9999992;
		...
		class RscButton_1400: husky_RscButton
		{
			idc = 10000002;
		...
		class CtrlGrp: husky_RscControlsGroup
		{
			idc = -1;
			...
			class Controls
			{
				class Textoutput: husky_RscStructuredText
				{
					idc = 9999994;
					x = 0;
					y = 0;
...
class aapps_adminlogs {
	...
	class controls
	{
		class husky_RscListbox_1500: husky_RscListNBox
		{
			idc = 9999998;
...
class aapps_develop_dialog
{
	...
	class controlsBackground {
		...
		class background_players: husky_RscText
		{
			idc = -1;
        ...
        class RscText_10084: husky_RscText
        {
            idc = -1;
		...
		class RscText_1014: husky_RscText
		{
			idc = -1;
		...
		class RscText_1015: husky_RscText
		{
			idc = -1;
		...
		class RscText_1016: husky_RscText
		{
			idc = -1;
	...
	class controls {
        ...
        class RscEdit_1401: husky_RscEdit //Consoleedit
		{
			idc = 3961506;
		...
		class RscEdit_1405: husky_RscEdit
		{
			idc = 3961513;
			text = "";
			x = 0.717594 * safezoneW + safezoneX;
		...
		class RscEdit_1406: husky_RscEdit
		{
			idc = 3961514;
			text = "";
			x = 0.717594 * safezoneW + safezoneX;
		...
		class RscEdit_1407: husky_RscEdit
		{
			idc = 3961515;
			text = "";
			x = 0.717594 * safezoneW + safezoneX;
		...
		class RscEdit_1408: husky_RscEdit
		{
			idc = 3961516;
			text = "";
			x = 0.717594 * safezoneW + safezoneX;
		...
		class RscEdit_1409: husky_RscEdit
		{
			idc = 3961517;
			text = "";
		...
		class RscEdit_1410: husky_RscEdit
		{
			idc = 3961518;
			text = "";
		...
		class RscButton_1605: husky_RscButton
		{
			idc = 3961520;
		...
		class RscButton_1606: husky_RscButton
		{
			idc = 3961521;
		...
		class RscText_1013: husky_RscText
		{
			idc = 3961522;
			text = "";
        ...
        class RscListbox_1503: husky_RscListbox
		{
			idc = 3961524;
			x = 0.717595 * safezoneW + safezoneX;
		...
		class RscButton_1607: husky_RscButton
		{
			idc = 3961527;
		...
		class RscButton_1608: husky_RscButton
		{
			idc = 3961528;
...
class aapps_adminspawner {
	...
	class controls {
		...
		class texturecombo: husky_RscCombo
		{
			idc = 9999942;
...
class aapps_keymapper {
	...
	class controls {
		...
		class RscListbox_1500: husky_RscListNBox
		{
			idc = 9999701;
			x = 0.296844 * safezoneW + safezoneX;
		...
		class RscText_1006: husky_RscStructuredText
		{
			idc = 9999702;
			text = "";
