...
*/
class temp_impound_dialog {
   idd = 8900;
   name = "temp_impound_dialog";
   movingenable = 0;
   enablesimulation = 1;
   ...
   class controls
   {
       class InfoMsg_temp : husky_RscStructuredText
       {
           ...
           sizeex = 0.020;
		   align = "center";
		   text = "Möchtest du wirklich das Fahrzeug bis zum nächsten Restart beschlagnahmen?";
       ...
       {
           text = "$STR_vInAct_ImpoundTemp";
           onbuttonclick = "closeDialog 0;[husky_vInact_curTarget] spawn husky_fnc_impoundTempAction;";
