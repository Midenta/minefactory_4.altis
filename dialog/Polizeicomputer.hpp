...
class polizeicomputer {
   ...
   class controlsBackground
   {
       ...
       {
           idc = 70082;
           text = "<t size='1' align='center'>Straftaten</t>";
       ...
       {
           idc = 70084;
           text = "<t size='1' align='center'>Straftat</t>";
       ...
       {
           idc = 70085;
           text = "<t size='1' align='center'>Infos über den Gesuchten</t>";
   ...
   class controls
   {
       class RscListbox_1501 : husky_RscListbox
       {
           ...
           onlbselchanged = "_this call husky_fnc_textinfo";
           sizeex = 0.04;
           colortext[] = {1,1,1,1};
       };
       ...
       class RscButtonMenu_2400 : husky_RscButtonMenu
       {
           ...
           h = 0.039216 * safezoneH;
           onbuttonclick = "closedialog 0; createDialog ""Polizeibericht"";";
       };
       class RscButtonMenu_2402 : husky_RscButtonMenu
       {
           ...
           x = 0.400000000000001 * safezoneW + safezoneX;
           y = 0.785241248817408 * safezoneH + safezoneY;
           w = 0.122395833333333 * safezoneW;
           h = 0.039216 * safezoneH;
           onbuttonclick = "closeDialog 0; [husky_Fahndung,1] remoteExec[""TON_fnc_Fahndung"", 2];";
       };
       class RscButtonMenu_24020 : husky_RscButtonMenu
       {
           idc = 7015085;
           text = "Fahndung einstellen";
           x = 0.524739583333334 * safezoneW + safezoneX;
           y = 0.785241248817408 * safezoneH + safezoneY;
           w = 0.122395833333333 * safezoneW;
           h = 0.039216 * safezoneH;
           onbuttonclick = "closeDialog 0; [husky_Fahndung,0] remoteExec[""TON_fnc_Fahndung"", 2]";
       };
       class RscButtonMenu_2401 : husky_RscButtonMenu
       {
           ...
           w = 0.095589 * safezoneW;
           h = 0.039216 * safezoneH;
           onbuttonclick = "closeDialog 0;[] call husky_fnc_pcdbdelete;";
       };
       class RscButtonMenu_1441 : husky_RscButtonMenu
       {
           ...
           w = 0.095589 * safezoneW;
           h = 0.039216 * safezoneH;
           onbuttonclick = "closeDialog 0;[] call husky_fnc_statusupdate;";
       };
