...
*/
class trunk_inv_clear {
   idd = 86022;
   name = "trunk_inv_clear";
   movingenable = 0;
   enablesimulation = 1;
   ...
   class controls
   {
       class info : husky_RscStructuredText
       {
           ...
           sizeex = 0.020;
		   align = "center";
		   text = "Möchtest du wirklich den Kofferraum des Fahrzeugs beschlagnahmen?";
       ...
       {
           text = "Kofferraum leeren";
           onbuttonclick = "closeDialog 0;[husky_vInact_curTarget] spawn husky_fnc_trunk_clear;";
